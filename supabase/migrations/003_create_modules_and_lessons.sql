...
-- ============================================================
-- Run this in Supabase SQL Editor to fix the missing modules issue
-- This will create 4 modules and 3 lessons for the Web Development course

-- Step 1: Create 4 Modules for the Web Development Course
...
-- Step 2: Create 3 Lessons for Module 1
...
SELECT
  'Modules created successfully!' as status,
  COUNT(*) as module_count
FROM modules
WHERE course_id = '650e8400-e29b-41d4-a716-446655440001';
...
FROM lessons
WHERE module_id IN (
  SELECT id FROM modules WHERE course_id = '650e8400-e29b-41d4-a716-446655440001'
);